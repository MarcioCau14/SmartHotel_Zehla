...
function RadarChart({ data }: {data: Record<string, number>;}) {
  ...
  }, [values, center, radius, angleStep]);
...
export default function DNAWizard() {
  const [step, setStep] = useState(0); // Inicia no passo 0 (Clonagem)
  ...
  const handleCloneDNA = async () => {
    ...
    setIsCloning(true);
    try {
      const res = await fetch('/api/zcc/dna/clone', {
        method: 'POST',
      ...
      if (data.success) {
        // Mapeia os dados do cloner para o gráfico de radar
        const metrics = data.metrics;
        setClonedDNA({
          FORM: metrics.formality,
          ENTU: metrics.enthusiasm,
          EMPA: metrics.empathy,
          EMOJ: metrics.emojiLevel,
          CONC: metrics.conciseness,
          AUTH: metrics.authority,
          HUMO: metrics.humor,
        ...
        setStep(1); // Vai para o welcome após clonar
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#efefef] p-8 flex flex-col items-center">
      {/* Progress Header */}
      <div className="w-full max-w-4xl mb-12">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#FF5500]/20 rounded-lg">
              <Dna className="w-6 h-6 text-[#FF5500]" />
            </div>
            <div>
              <h1 className="text-xl font-bold font-serif">Mapeamento de DNA</h1>
              <p className="text-xs text-[#4d4d4d]">Configurando o seu Gêmeo Digital</p>
            </div>
          </div>
      ...
      <div className="w-full max-w-4xl glass-card p-8 min-h-[600px] flex flex-col relative overflow-hidden">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-[10px] font-bold text-orange-500 mb-4 uppercase tracking-widest">
                ...
                Tecnologia de Clonagem Real
              </div>
              <h2 className="text-4xl font-serif mb-4">Extraia o seu DNA</h2>
              <p className="text-[#858b91] max-w-2xl mx-auto">
                Não gaste tempo respondendo perguntas. Cole aqui o histórico de algumas conversas suas no WhatsApp 
                e o ZEHLA aprenderá instantaneamente o seu tom, gírias e jeito de vender.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-[10px] text-center text-neutral-600">
                Seus logs são processados de forma efêmera e não ficam armazenados. 
                Extraímos apenas as métricas de tom.
              </p>
            </div>
          </div>
        }
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 bg-orange-500/[0.03] border border-orange-500/10 p-8 rounded-3xl mb-12">
                ...
                <div className="space-y-4 max-w-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-neutral-300">DNA Extraído de Conversas Reais</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="mt-8 p-6 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-start gap-4">
              ...
              <p className="text-sm text-blue-200">
                <b>Privacidade Garantida:</b> Seus dados são usados exclusivamente para treinar o seu agente privado.
              </p>
            </div>
          </div>
        }
            ...
            <button
              ...
              'bg-white/5 border-white/10 hover:border-white/30'}`
                  ...
                  <div className="flex-1">
                    <div className="font-bold text-sm">{arc.title}</div>
                    <div className="text-xs text-[#858b91]">{arc.desc}</div>
                  </div>
                  <div className="text-[10px] font-mono text-[#4d4d4d] max-w-[200px] italic">
                    {arc.example}
                  </div>
                </button>
            )}
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 text-center">
            <div className="mb-12">
              ...
              <h2 className="text-3xl font-serif mb-4">DNA Mapeado com Sucesso!</h2>
              <p className="text-[#858b91] max-w-xl mx-auto">
                Seu Gêmeo Digital está pronto para ser ativado.
              </p>
            </div>
