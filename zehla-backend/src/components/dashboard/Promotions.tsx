    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="glass-card p-4 text-center">
          ...
          <div className="text-xl font-bold text-[#efefef]">{promos.filter(p => p.status === 'active').length}</div>
          <div className="text-xs text-[#4d4d4d]">Ativas</div>
        </div>
        <div className="glass-card p-4 text-center">
          <Percent className="w-5 h-5 text-[#FF5500] mx-auto mb-2" />
          <div className="text-xl font-bold text-[#efefef]">R$ {(promos.reduce((s, p) => s + p.revenue, 0)).toLocaleString('pt-BR')}</div>
          <div className="text-xs text-[#4d4d4d]">Receita Total</div>
        </div>
        <div className="glass-card p-4 text-center">
          <Users className="w-5 h-5 text-[#FF5500] mx-auto mb-2" />
          <div className="text-xl font-bold text-[#efefef]">{promos.reduce((s, p) => s + p.bookings, 0)}</div>
