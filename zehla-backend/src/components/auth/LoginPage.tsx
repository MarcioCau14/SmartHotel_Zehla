...
export function LoginPage({ onBack, onLogin, onGoToRegister }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      document.cookie = `zehla-token=${data.data.token}; path=/; max-age=86400`;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 text-[#4d4d4d] hover:text-[#b4b4b4] transition-colors mb-8 text-sm"
        >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="glass-card p-6 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-[#242424] border border-[#363636] rounded-xl text-sm text-[#fafafa] placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500/50 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 bg-[#242424] border border-[#363636] rounded-xl text-sm text-[#fafafa] placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500/50 transition-all"
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-all shadow-lg shadow-orange-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-[#4d4d4d]">
              ...
              <button
                ...
                className="text-[#FF5500] hover:text-orange-300 font-medium transition-colors"
              >
          ...
          <p className="text-xs text-[#363636] text-center mt-4">
            <Zap className="w-3 h-3 inline text-orange-500" /> ZEHLA absorve todos os custos de IA
          </p>
        </motion.div>
      </div>
    </div>
