      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-4">
            Ainda com <span className="gradient-text">dúvidas?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10">
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-center text-[10px] text-neutral-500">
                      ...
                      <Link href="#" className="text-neutral-400 underline underline-offset-2 hover:text-emerald-400 transition-colors">
          ...
          >
            <div className="p-6 rounded-2xl border border-white/[0.03] bg-[#070709] shadow-2xl">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] text-neutral-500 uppercase tracking-wider font-semibold">Comercial</p>
                    <a
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] text-neutral-500 uppercase tracking-wider font-semibold">Suporte Técnico</p>
                    <a
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] text-neutral-500 uppercase tracking-wider font-semibold">WhatsApp de Plantão</p>
                    <a
            ...
            {/* Atendimento Note */}
            <div className="p-6 rounded-2xl border border-white/[0.02] bg-[#070709]/50 text-neutral-500 text-xs leading-relaxed">
