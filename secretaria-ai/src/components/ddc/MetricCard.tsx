...
export function MetricCard({
  ...
  return (
    ...
    >
      <Card
        className={`bg-gradient-to-br ${bgColor} border border-white/[0.08] hover:border-white/[0.12] transition-all duration-300 overflow-hidden cursor-pointer ${onClick ? 'hover:scale-[1.02]' : ''}`}
      >
        {/* Live indicator */}
        {live && (
