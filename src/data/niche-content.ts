...
// ═══════════════════════════════════════════════════════════════
// PARCEIRO CONTENT — R$297 único por 24 meses
// ═══════════════════════════════════════════════════════════════
const parceiroContent: NicheContent = {
  switcher: {
    headline: 'Pague uma vez. Use por 24 meses.',
    subheadline: 'O plano Parceiro Zélla é um investimento único de R$297 com 2 anos completos de IA atendendo seus hóspedes. Sem mensalidade, sem surpresa — economia de até R$7.347 comparado aos planos mensais.',
    heroStat: { val: 'R$297', label: 'por 24 meses de acesso' },
    backgroundImage: '/images/niche-parceiro-bg.jpg',
    ctaText: 'Garantir meu acesso Parceiro',
    accentColor: 'amber',
  ...
  painCards: [
    {
      icon: 'Crown',
      title: 'R$297 por 24 meses — sério',
      desc: 'Um único pagamento de R$297 e você tem 2 anos inteiros do Zélla atendendo seus hóspedes. Enquanto outros pagam R$197/mês (R$4.728 em 2 anos), você paga R$297 uma vez. Economia real de R$4.431.',
      stat: { val: 'R$4.431', label: 'Economia em 24 meses' },
      color: 'amber',
      size: 'lg',
    },
    {
      ...
      desc: 'Esqueça fatura mensal. No plano Parceiro, você paga R$297 uma vez e pronto. Sem cobrança recorrente, sem reajuste surpresa, sem cartão de crédito guardado. Transparência total.',
      stat: { val: '0', label: 'Mensalidades nos 24 meses' },
      color: 'emerald',
      size: 'lg',
    },
    {
      icon: 'ShieldCheck',
      title: 'As mesmas funcionalidades do LITE',
      desc: 'O plano Parceiro inclui tudo do LITE: IA 24/7 no WhatsApp, PIX integrado, dashboard completo, respostas personalizadas, relatórios semanais. A diferença? Você paga uma vez e usa por 2 anos.',
      color: 'blue',
      size: 'sm',
    },
    {
      icon: 'Zap',
      title: 'Mesma IA, mesma qualidade',
      desc: 'O Zélla atende seus hóspedes com a mesma qualidade e velocidade do planos mensais. Respostas em 8 segundos, tom personalizado, chave PIX automática. O atendimento não muda — só o preço.',
      color: 'sky',
      size: 'sm',
    },
    {
      icon: 'TrendingUp',
      title: 'Se paga sozinho na primeira semana',
      desc: 'Uma única reserva direta gerada pelo Zélla já cobre os R$297 do plano. Depois disso, são 23 meses e 3 semanas de lucro puro. Cada reserva extra é dinheiro direto no seu bolso.',
    ...
    {
      icon: 'Clock',
      title: 'Válido por 24 meses a partir da ativação',
      desc: 'O acesso de 24 meses começa quando você ativar — não na compra. Compre agora, ative quando quiser. Sem pressa, sem desperdício. O tempo começa a contar quando o Zélla começar a trabalhar por você.',
      color: 'pink',
      size: 'sm',
    },
  ],
  ...
  steps: [
    {
      num: '01',
      icon: 'CreditCard',
      title: 'Pague R$297 uma vez',
      subtitle: 'PIX na hora, sem burocracia',
      desc: 'Faça o pagamento único de R$297 via PIX. Sem cartão de crédito, sem mensalidade, sem surpresa. Em minutos você recebe o acesso completo ao Zélla por 24 meses.',
      color: 'amber',
      highlights: ['Pagamento único via PIX', 'Sem cartão de crédito', 'Acesso imediato após confirmação'],
      fields: ['Nome completo', 'WhatsApp', 'E-mail', 'Chave PIX para pagamento'],
    },
    {
      num: '02',
      icon: 'UserPlus',
    ...
    },
    {
      num: '03',
      icon: 'TrendingUp',
      title: '2 anos de IA trabalhando por você',
      subtitle: 'Sem pagar mais nada',
      desc: 'Aproveite 24 meses completos do Zélla atendendo seus hóspedes, gerando reservas e economizando comissões. Sem fatura mensal, sem reajuste, sem preocupação. Foque no que importa — o Zélla cuida do resto.',
      color: 'violet',
      highlights: ['24 meses de acesso total', 'Sem cobranças extras', 'Suporte incluído'],
    },
  ],
  ...
  features: [
    {
      ...
      heroStat: { val: 'R$297', label: 'por 24 meses', gradient: 'from-amber-400 to-yellow-400' },
      headline: 'Um pagamento. Dois anos de IA.',
      subtitle: 'O plano que se paga sozinho na primeira reserva.',
      desc: 'Enquanto o plano LITE custa R$197/mês (R$4.728 em 24 meses), o Parceiro oferece o mesmo por R$297 uma vez. Economia de R$4.431 que fica no seu bolso. Mesma IA, mesmo atendimento, mesma qualidade — preço de parceiro.',
      stats: [
        { val: 'R$4.431', label: 'Economia vs. LITE mensal', sublabel: 'Em 24 meses de uso', icon: 'DollarSign' },
        { val: 'R$12,38', label: 'Custo mensal equivalente', sublabel: 'R$297 ÷ 24 meses', icon: 'Calculator' },
      ],
      pills: [
        { text: 'Pagamento único — sem mensalidade', accent: true },
        { text: 'Mesmas funcionalidades do LITE' },
        { text: '24 meses de acesso completo' },
        { text: 'Se paga na primeira reserva' },
      ],
      bottomLine: 'R$12,38/mês equivalente. Menos que um café por dia para ter IA 24/7.',
      mockup: 'whatsapp',
      reverse: false,
    },
    {
      ...
      heroStat: { val: '93%', label: 'de economia', gradient: 'from-amber-400 to-orange-400' },
      headline: 'Veja quanto você economiza.',
      subtitle: 'O Parceiro é o melhor custo-benefício do Zélla.',
      desc: 'Em 24 meses, o plano LITE custa R$4.728. O PRO custa R$9.528. O Parceiro custa R$297. Mesmo atendimento 24/7, mesmo PIX integrado, mesmo dashboard. A diferença? Milhares de reais que ficam no seu bolso.',
      stats: [
        { val: 'R$4.728', label: 'LITE em 24 meses', sublabel: 'R$197 × 24', icon: 'DollarSign' },
        { val: 'R$297', label: 'Parceiro em 24 meses', sublabel: 'Pagamento único', icon: 'Crown' },
      ],
      pills: [
        { text: 'LITE: R$4.728 em 2 anos', accent: false },
        { text: 'PRO: R$9.528 em 2 anos', accent: false },
        { text: 'Parceiro: R$297 por 2 anos', accent: true },
        { text: 'Economia de até 93% vs. PRO', accent: true },
      ],
      bottomLine: 'O melhor negócio do Zélla. Limitado — aproveite enquanto está disponível.',
      mockup: 'linkinbio',
      reverse: true,
    },
  ],
  ...
  dashboard: {
    ...
    desc: 'O plano Parceiro inclui o mesmo dashboard, a mesma IA e os mesmos relatórios dos planos mensais. Acompanhe reservas, receita e atendimento em tempo real — sem pagar mais nada por 24 meses.',
    pains: [
      { icon: 'Activity', title: 'Dashboard Completo', desc: 'Reservas geradas, receita do dia, taxa de ocupação — tudo em tempo real. Relatórios semanais automáticos no seu e-mail, igual aos planos mensais.' },
      { icon: 'DollarSign', title: 'Economia Que Se Vê', desc: 'Veja exatamente quanto o plano Parceiro está economizando comparado ao mensal. Cada reserva gerada é dinheiro direto — sem descontar mensalidade.' },
      { icon: 'TrendingUp', title: 'ROI Visível desde a Primeira Semana', desc: 'Uma única reserva gerada pelo Zélla já cobre os R$297. Depois disso, são 23+ meses de lucro puro. O ROI é visível no painel desde o primeiro dia.' },
    ],
    stats: [
      { label: 'Pagamento único', val: 'R$297', title: 'Investimento total', color: 'text-amber-400' },
      { label: 'Mesmo atendimento dos planos mensais', val: '24/7', title: 'IA no WhatsApp', color: 'text-emerald-400' },
      { label: 'Custo mensal equivalente', val: 'R$12,38', title: 'Por mês', color: 'text-blue-400' },
      { label: 'Economia vs. LITE mensal', val: '93%', title: 'Desconto real', color: 'text-zinc-300' },
    ],
    recentActivity: [
      { color: 'bg-amber-400', text: 'Plano Parceiro ativado com sucesso', time: 'agora' },
    ...
    footerRight: { icon: 'Crown', label: 'Investimento Parceiro:', value: 'R$ 297,00 (único)' },
    chatConversation: [
      { sender: 'user', name: 'Luciana Ferreira', text: 'Olá! Vi que vocês têm um plano de R$297 por 2 anos. Isso é real? Como funciona?' },
      { sender: 'bot', confidence: '99%', actions: 'Plano Parceiro selecionado', text: 'Olá, Luciana! Sim, o Plano Parceiro é real: R$297 pagos uma vez e 24 meses de acesso completo ao Zélla. Mesma IA 24/7, mesmo PIX integrado, mesmo dashboard. A diferença? Você economiza R$4.431 comparado ao plano mensal. Quer ativar agora?' },
      { sender: 'user', name: 'Luciana Ferreira', text: 'Isso é incrível! Quero ativar o Parceiro agora mesmo!' },
    ],
  },
  ...
  testimonials: [
    {
      ...
      text: 'R$297 por 2 anos? Eu achei que era erro de preço. Mas é real. A primeira reserva que o Zélla gerou já cobriu o investimento. Depois disso, foram 6 meses de lucro puro sem pagar mensalidade.',
      avatar: '/avatar-serenity.jpg',
      rating: 5,
    },
    {
      ...
      text: 'Eu estava em dúvida entre o mensal e o Parceiro. Fiz as contas: R$197/mês = R$4.728 em 2 anos. O Parceiro é R$297 uma vez. Não tem comparação. Economia de mais de 4 mil reais!',
      avatar: '/pousada-vista.jpg',
      rating: 5,
    },
    {
      ...
      text: 'O plano Parceiro é o melhor negócio que já fiz. Paguei R$297, configurei em 5 minutos e em 3 dias já tinha a primeira reserva. Em 2 meses já gerei R$3.200 em reservas diretas. ROI de 10x.',
      avatar: '/pousada-chale.jpg',
      rating: 5,
    },
  ],
  ...
  pricing: {
    focusLabel: 'Economia real e visível',
    focusDesc: 'R$297 uma vez por 24 meses de acesso completo. Sem mensalidade. O plano que se paga sozinho na primeira reserva e ainda sobram 23+ meses de lucro.',
  },

  faqs: [
    { question: 'O plano Parceiro é realmente R$297 por 24 meses?', answer: 'Sim! R$297 pagos uma única vez via PIX e você tem 24 meses completos de acesso ao Zélla. Sem mensalidade, sem cobrança recorrente, sem surpresa. É o nosso melhor custo-benefício.' },
    { question: 'O Parceiro tem as mesmas funcionalidades do LITE?', answer: 'Sim! O plano Parceiro inclui tudo do LITE: IA 24/7 no WhatsApp, PIX integrado, dashboard completo, respostas personalizadas e relatórios semanais. A diferença é o preço — você paga uma vez e usa por 2 anos.' },
    { question: 'Quanto eu economizo comparado ao plano mensal?', answer: 'O LITE custa R$197/mês — R$4.728 em 24 meses. O Parceiro custa R$297 uma vez. Economia de R$4.431, ou 93% de desconto real. O custo mensal equivalente é de apenas R$12,38.' },
    { question: 'Quando começam os 24 meses?', answer: 'Os 24 meses começam a contar a partir da ativação, não da compra. Compre agora e ative quando quiser — sem pressa, sem desperdício.' },
    { question: 'Posso usar para pousada e para Airbnb?', answer: 'Sim! O plano Parceiro funciona para ambos. Você pode cadastrar sua pousada ou colar a URL do seu anúncio Airbnb — a IA importa tudo automaticamente.' },
    { question: 'E se eu quiser mais funcionalidades depois?', answer: 'Se precisar de recursos dos planos PRO ou MAX (mensagens ilimitadas, campanhas, importação de anúncios), você pode fazer upgrade pagando apenas a diferença. Seu investimento de R$297 é preservado.' },
  ],
};
