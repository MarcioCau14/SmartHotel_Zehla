...
const parceiroContent: NicheContent = {
  switcher: {
    headline: 'Plano PRO por R$247/mês. Preço congelado por 24 meses.',
    subheadline: 'Como Parceiro Zélla, você acessa o plano PRO completo por R$247/mês — R$150 a menos que o preço regular. Preço congelado por 24 meses + selo exclusivo de parceiro no Link-in-Bio + link para fixar no Instagram. Economia de R$3.600 em 2 anos.',
    heroStat: { val: 'R$247/mês', label: 'PRO por 24 meses congelado' },
  ...
  painCards: [
    {
      icon: 'Crown',
      title: 'PRO por R$247/mês — preço de parceiro',
      desc: 'O plano PRO regular custa R$397/mês. Como Parceiro Zélla, você paga apenas R$247/mês com o preço congelado por 24 meses. São R$150 de desconto todo mês — R$3.600 de economia em 2 anos. Atendimento ilimitado, mensagens ilimitadas, tudo do PRO. E ainda ganha o selo de parceiro no perfil Link-in-Bio para fixar no Instagram.',
      stat: { val: 'R$3.600', label: 'Economia em 24 meses' },
      color: 'amber',
      size: 'lg',
    },
    {
      icon: 'ShieldCheck',
      title: 'Selo de Parceiro no Link-in-Bio + Instagram',
      desc: 'Receba o selo de parceiro oficial no seu perfil Link-in-Bio fornecido pelo Zélla. O link pode ser fixado no perfil do Instagram, transmitindo credibilidade e confiança. Seus clientes sabem que estão sendo atendidos por uma operação certificada. Diferencial competitivo que ninguém mais tem.',
      stat: { val: 'OFICIAL', label: 'Selo no Link-in-Bio' },
      color: 'emerald',
      size: 'lg',
    },
    {
      ...
      desc: 'Mesmo que o plano PRO sofra reajuste, seu preço de R$247/mês fica travado por 24 meses. Sem surpresa, sem reajuste inesperado. Você sabe exatamente quanto vai pagar durante 2 anos inteiros.',
      color: 'blue',
      size: 'sm',
    },
    {
    ...
    },
    {
      ...
      desc: 'O programa Parceiro Zélla tem vagas limitadas. Ao se tornar parceiro, você garante R$247/mês congelados por 24 meses — mesmo que o preço regular do PRO suba. Quanto antes entrar, mais economiza.',
      color: 'pink',
      size: 'sm',
    },
  ],
  ...
  steps: [
    {
      num: '01',
      icon: 'CreditCard',
      title: 'Assine o Parceiro por R$247/mês',
      subtitle: 'Cartão ou PIX — sem burocracia',
      desc: 'Assine o plano Parceiro Zélla por R$247/mês com o preço congelado por 24 meses. Pagamento mensal via PIX ou cartão de crédito. Em minutos você recebe o acesso completo ao PRO + selo exclusivo de parceiro no seu Link-in-Bio + link para fixar no Instagram.',
      color: 'amber',
      highlights: ['R$247/mês congelado por 24 meses', 'PIX ou cartão de crédito', 'Acesso imediato ao plano PRO + Link-in-Bio'],
    ...
    },
    {
      ...
      desc: 'Aproveite 24 meses de plano PRO completo por R$247/mês — R$150 a menos que o regular. Atendimento ilimitado, mensagens ilimitadas, suporte prioritário, tudo incluído. Foque no que importa — o Zélla cuida do resto.',
      color: 'violet',
      highlights: ['24 meses de PRO congelado', 'R$150/mês de desconto', 'Suporte prioritário incluído'],
    },
  ],
  ...
  features: [
    {
      ...
      heroStat: { val: 'R$247/mês', label: 'PRO congelado por 24 meses', gradient: 'from-amber-400 to-yellow-400' },
      headline: 'Plano PRO. Preço de Parceiro.',
      subtitle: 'R$150 de desconto todo mês + selo exclusivo no Link-in-Bio.',
      desc: 'O plano PRO regular custa R$397/mês. Como Parceiro Zélla, você paga R$247/mês com preço congelado por 24 meses — são R$150 de economia todo mês, totalizando R$3.600 em 2 anos. Atendimento ilimitado, mensagens ilimitadas, suporte prioritário, tudo do PRO. E ainda ganha o selo exclusivo de parceiro no perfil Link-in-Bio — link para fixar no Instagram.',
      stats: [
        { val: 'R$3.600', label: 'Economia vs. PRO regular', sublabel: 'R$150 × 24 meses', icon: 'DollarSign' },
        { val: 'R$150', label: 'Desconto por mês', sublabel: 'R$397 → R$247', icon: 'TrendingUp' },
      ],
      pills: [
        { text: 'Plano PRO completo — R$247/mês', accent: true },
        { text: 'Preço congelado por 24 meses' },
        { text: 'Selo de Parceiro no Link-in-Bio' },
        { text: 'Link para fixar no Instagram' },
        { text: 'Atendimento e mensagens ilimitados' },
      ],
      bottomLine: 'R$150 a menos por mês durante 2 anos + selo no Link-in-Bio. O PRO nunca foi tão acessível.',
      mockup: 'whatsapp',
      reverse: false,
    },
    {
      ...
      heroStat: { val: '38%', label: 'de desconto no PRO', gradient: 'from-amber-400 to-orange-400' },
      headline: 'Veja quanto você economiza.',
      subtitle: 'O Parceiro é o melhor custo-benefício do Zélla.',
      desc: 'Em 24 meses, o plano PRO regular custa R$9.528. O Parceiro Zélla custa R$5.928 — os mesmos R$247/mês congelados. Economia de R$3.600 que fica no seu bolso. Mesmo PRO, mesmas funcionalidades, mesmo atendimento — preço de parceiro + selo no Link-in-Bio para fixar no Instagram.',
      stats: [
        { val: 'R$9.528', label: 'PRO regular em 24 meses', sublabel: 'R$397 × 24', icon: 'DollarSign' },
        { val: 'R$5.928', label: 'Parceiro em 24 meses', sublabel: 'R$247 × 24', icon: 'Crown' },
      ],
      pills: [
        { text: 'PRO regular: R$397/mês', accent: false },
        { text: 'Parceiro Zélla: R$247/mês', accent: true },
        { text: 'Economia de R$3.600 em 2 anos', accent: true },
        { text: 'Selo no Link-in-Bio + Instagram', accent: true },
      ],
  ...
  dashboard: {
    ...
    desc: 'O plano Parceiro dá acesso total ao dashboard PRO: métricas de atendimento, receita gerada, campanhas ativas, análise de sentimento — tudo em tempo real. Acompanhe seu ROI e veja a economia de R$150/mês acontecendo. Além disso, receba o selo de parceiro no seu perfil Link-in-Bio — link para fixar no Instagram e aumentar sua credibilidade.',
    pains: [
      ...
      { icon: 'DollarSign', title: 'Economia de R$150/mês', desc: 'Veja exatamente quanto está economizando como Parceiro: R$150 todo mês comparado ao PRO regular. Em 24 meses, são R$3.600 que ficam no seu bolso.' },
      { icon: 'TrendingUp', title: 'ROI Visível desde a Primeira Semana', desc: 'Com mensagens ilimitadas e atendimento ilimitado, um único contrato gerado pelo Zélla já cobre a mensalidade de R$247. O ROI é visível no painel desde o primeiro dia.' },
    ],
    stats: [
      { label: 'Mensalidade Parceiro', val: 'R$247', title: 'Por mês (congelado)', color: 'text-amber-400' },
      { label: 'Atendimento 24/7', val: 'IA ativa', title: 'No WhatsApp', color: 'text-emerald-400' },
      { label: 'Desconto vs. PRO regular', val: 'R$150', title: 'Por mês', color: 'text-blue-400' },
      { label: 'Economia em 24 meses', val: 'R$3.600', title: 'Total garantido', color: 'text-zinc-300' },
    ],
    recentActivity: [
      { color: 'bg-amber-400', text: 'Plano Parceiro Zélla ativado com sucesso', time: 'agora' },
      { color: 'bg-emerald-400', text: 'Primeiro resultado gerado pela IA', time: '18h' },
      { color: 'bg-blue-400', text: 'Pagamento confirmado — R$247,00', time: '1d' },
    ],
    footerLeft: { icon: 'DollarSign', label: 'Receita Gerada pela IA:', value: 'R$ 2.340,00' },
    footerRight: { icon: 'Crown', label: 'Plano Parceiro Zélla:', value: 'R$ 247,00/mês' },
    chatConversation: [
      { sender: 'user', name: 'Luciana Ferreira', text: 'Olá! Vi que vocês têm o plano Parceiro Zélla por R$247/mês. Como funciona o preço congelado?' },
      { sender: 'bot', confidence: '99%', actions: 'Plano Parceiro selecionado', text: 'Olá, Luciana! O Plano Parceiro Zélla é simples: você paga R$247/mês e o preço fica congelado por 24 meses — mesmo que o PRO regular suba. São R$150 de desconto por mês em relação ao PRO de R$397. Tudo do PRO: atendimento ilimitado, mensagens ilimitadas, suporte prioritário. E ainda ganha o selo exclusivo de parceiro no seu Link-in-Bio — link para fixar no Instagram. Quer garantir sua vaga?' },
  ...
  testimonials: [
    {
      ...
      text: 'R$247/mês pelo PRO congelado por 2 anos? É o melhor negócio que já fiz. O PRO regular é R$397, então já economizo R$150 todo mês. O primeiro resultado que o Zélla gerou já cobriu a mensalidade. Depois disso, é lucro. E ainda ganho o selo no Link-in-Bio para fixar no Instagram!',
      avatar: '/avatar-serenity.jpg',
      rating: 5,
    },
    {
      ...
      role: 'Parceira Zélla',
      location: 'Ubatuba, SP',
      text: 'Eu estava em dúvida entre o PRO regular e o Parceiro. Fiz as contas: R$397/mês = R$9.528 em 2 anos. O Parceiro é R$247/mês = R$5.928. Economia de R$3.600! E é o mesmo PRO completo com selo de parceiro no Link-in-Bio para fixar no Instagram.',
      avatar: '/pousada-vista.jpg',
      rating: 5,
    },
    {
      ...
      text: 'O plano Parceiro Zélla é imbatível. R$247/mês com tudo do PRO: mensagens ilimitadas, atendimento ilimitado, preço congelado por 24 meses. Configurei em 5 minutos e em 3 dias já tinha o primeiro resultado. ROI de 10x. O selo no Link-in-Bio ainda me dá mais credibilidade no Instagram.',
      avatar: '/pousada-chale.jpg',
      rating: 5,
    },
  ],
  ...
  pricing: {
    ...
    focusDesc: 'R$247/mês congelados por 24 meses. Plano PRO completo com atendimento e mensagens ilimitados + selo exclusivo de parceiro no Link-in-Bio + link para fixar no Instagram. Economia de R$3.600 vs. PRO regular.',
  },

  faqs: [
    { question: 'O plano Parceiro é realmente R$247/mês?', answer: 'Sim! Como Parceiro Zélla, você paga R$247/mês pelo plano PRO completo — R$150 a menos que o preço regular de R$397/mês. O preço fica congelado por 24 meses, sem reajuste. É o nosso melhor custo-benefício.' },
    { question: 'O Parceiro tem as mesmas funcionalidades do PRO?', answer: 'Sim! O plano Parceiro inclui tudo do PRO: atendimento ilimitado, mensagens ilimitadas, IA 24/7 no WhatsApp, campanhas automatizadas, análise de sentimento, suporte prioritário e dashboard completo. A diferença? Você paga R$150 a menos por mês e ganha o selo exclusivo de parceiro no seu perfil Link-in-Bio — link para fixar no Instagram.' },
    { question: 'O que é o selo de Parceiro no Link-in-Bio?', answer: 'O selo de Parceiro Zélla é um distintivo oficial que aparece no seu perfil Link-in-Bio fornecido pelo Zélla. O link pode ser fixado no perfil do Instagram, transmitindo credibilidade e confiança. Seus clientes veem que você é certificado pelo Zélla. Apenas parceiros têm esse selo.' },
    { question: 'O preço de R$247/mês pode subir?', answer: 'Não durante 24 meses. Seu preço de R$247/mês fica congelado por 24 meses a partir da ativação, mesmo que o plano PRO regular sofra reajuste. Transparência total — você sabe exatamente quanto vai pagar.' },
    { question: 'O Parceiro funciona para qualquer tipo de operação?', answer: 'Sim! O plano Parceiro Zélla funciona para qualquer operação de atendimento — de turismo a serviços, de comércio a consultorias. Você cadastra sua operação e a IA importa tudo automaticamente. Atendimento e mensagens são ilimitados para qualquer tipo de negócio.' },
    { question: 'O que é o Link-in-Bio fornecido pelo Zélla?', answer: 'É um perfil profissional fornecido pelo Zélla com o selo de parceiro oficial. O link pode ser fixado no perfil do Instagram, permitindo que seus clientes acessem suas informações e reservas diretamente. É mais uma vantagem exclusiva do programa Parceiro Zélla.' },
  ],
};
