  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card p-5">
        <h3 className="text-sm font-semibold text-neutral-300 mb-4">Métricas de Escala</h3>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {scaleMetrics.map((m, i) => (
            <div key={i} className="bg-white/[0.02] rounded-lg p-3">
              ...
              <div className={`text-sm font-mono font-bold ${m.ok ? 'text-emerald-400' : 'text-red-400'}`}>
                {m.value}
              </div>
              <div className="text-[10px] text-neutral-600">{m.trend}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Tokens by tenant */}
      <div className="glass-card p-5">
        <h3 className="text-sm font-semibold text-neutral-300 mb-4">Tokens por Tenant</h3>
      ...
      {/* Response times */}
      <div className="glass-card p-5">
        <h3 className="text-sm font-semibold text-neutral-300 mb-4">Tempos de Resposta (percentis)</h3>
        <ResponsiveContainer width="100%" height={200}>
        ...
        <div className="flex gap-4 mt-3 justify-center">
          <div className="flex items-center gap-1.5 text-xs text-neutral-500">
            <div className="w-3 h-0.5 bg-emerald-500" /> P50
          </div>
          <div className="flex items-center gap-1.5 text-xs text-neutral-500">
