...
// ============================================================================
// LEARNING STATS API (Cérebro que Aprende)
// ============================================================================

export async function fetchLearningStats(): Promise<ApiResponse<LearningStatsResponse>> {
  const response = await fetch(`${API_BASE}/learning-stats`);
  return handleResponse<LearningStatsResponse>(response);
}
