...
import { Brain, Zap, Menu, X, Phone, Mail } from 'lucide-react';
...
import { getUTMQueryString } from '@/hooks/useUTMParams';
...
export function LandingClient({ headline, highlight, subtitle }: LandingClientProps) {
